class Services::Shared::Migrations::MigrationsV2 < Services::Shared::Migrations::Migrations
  ...
  def complete_mismatch_sheet
    ...
    fetch_csv('before_batch_2.csv', csv_data)
  end

  def update_non_kit_non_ae_except_zero_tsp
    service = Services::Shared::Spreadsheets::CsvImporter.new('second_run_mismatch.csv', 'seed_files_3')
    corrected = []
    tax_mismatch = []
    repeating_rows = []
    quantity_mismatch = []
