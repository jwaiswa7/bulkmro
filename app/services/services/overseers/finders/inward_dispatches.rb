class Services::Overseers::Finders::InwardDispatches < Services::Overseers::Finders::BaseFinder
  ...
  def perform_query(query_string)
    indexed_records = index_klass.query(multi_match: { query: query_string, operator: 'and', fields: %w[ po_number_string inquiry supplier ar_invoice_request_status_string status_string customer po_date so_number_string] }).order(sort_definition)
