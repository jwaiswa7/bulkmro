class Services::Overseers::Exporters::InquiriesExporter < Services::Overseers::Exporters::BaseExporter
  def initialize(*params)
    ...
    @columns = ['inquiry_number', 'order_number', 'created_at', 'customer_committed_date', 'updated_at', 'quote_type', 'quote_date', 'last_quote_date', 'status', 'opportunity_type', 'inside_sales_owner', 'ise_city', 'outside_sales_owner', 'ose_city', 'company_alias', 'company_name', 'customer', 'subject', 'currency', 'potential amount', 'overall_margin(%)', 'total (Exc. Tax)', 'products count', 'comments', 'reason', 'customer_order_date', 'customer_po_number']
