  ...
  def call
    ...
    @params.each do |index, po_request_hash|
      ...
      if @order.class.name == 'SalesOrder'
        po_requests[po_request_hash[:supplier_id]] = @order.po_requests.build(inquiry_id: @order.inquiry.id, supplier_id: po_request_hash[:supplier_id], status: po_request_hash[:status], supplier_po_type: po_request_hash[:supplier_po_type], bill_from_id: po_request_hash[:bill_from_id], ship_from_id: po_request_hash[:ship_from_id], bill_to_id: po_request_hash[:bill_to_id], ship_to_id: po_request_hash[:ship_to_id], contact_id: po_request_hash[:contact_id], contact_phone: contact_phone, contact_email: contact_email, supplier_committed_date: po_request_hash[:supplier_committed_date], payment_option_id: po_request_hash[:payment_option_id], attachments: attachments, transport_mode: po_request_hash[:transport_mode], delivery_type: po_request_hash[:delivery_type])
      elsif @order.class.name == 'Inquiry'
        po_requests[po_request_hash[:supplier_id]] = @order.po_requests.build(inquiry_id: @order.id, supplier_id: po_request_hash[:supplier_id], stock_status: po_request_hash[:stock_status], supplier_po_type: po_request_hash[:supplier_po_type], bill_from_id: po_request_hash[:bill_from_id], ship_from_id: po_request_hash[:ship_from_id], bill_to_id: po_request_hash[:bill_to_id], ship_to_id: po_request_hash[:ship_to_id], contact_id: po_request_hash[:contact_id], contact_phone: contact_phone, contact_email: contact_email, supplier_committed_date: po_request_hash[:supplier_committed_date], payment_option_id: po_request_hash[:payment_option_id], requested_by_id: po_request_hash[:requested_by_id], approved_by_id: po_request_hash[:approved_by_id], reason_to_stock: po_request_hash[:reason_to_stock], estimated_date_to_unstock: po_request_hash[:estimated_date_to_unstock], attachments: attachments, transport_mode: po_request_hash[:transport_mode], delivery_type: po_request_hash[:delivery_type])
      end
      blobs = Array.new
      ...
      if po_request_hash[:rows_attributes].present?
        po_request_hash[:rows_attributes].each do |row_index, row_hash|
          if !row_hash[:_destroy].present? && row_hash[:quantity].present?
            ...
            po_requests[po_request_hash[:supplier_id]].rows.build(sales_order_row_id: row_hash[:sales_order_row_id], quantity: row_hash[:quantity], product_id: row_hash[:product_id], brand_id: row_hash[:brand_id], tax_code_id: row_hash[:tax_code_id], tax_rate_id: row_hash[:tax_rate_id], measurement_unit_id: measurement_unit_id, unit_price: row_hash[:unit_price], discount_percentage: row_hash[:discount_percentage], lead_time: row_hash[:lead_time],  default_currency: row_hash[:default_currency], unit_price_with_selected_currency: row_hash[:unit_price_with_selected_currency])
          end
        end
      end
    end
