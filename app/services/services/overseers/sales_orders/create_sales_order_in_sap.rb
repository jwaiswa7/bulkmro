class Services::Overseers::SalesOrders::CreateSalesOrderInSap < Services::Shared::BaseService
  ...
  def call
    if params['approve'].present?
      ...
      sales_order.update_attributes(remote_status: :'Supplier PO: Request Pending', status: :'Approved', mis_date: Date.today, order_number: order['DocNum'], remote_uid: order['DocEntry'])
