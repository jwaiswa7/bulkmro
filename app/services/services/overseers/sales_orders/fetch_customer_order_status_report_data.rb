  ...
  def fetch_data_bm_wise
    ...
    indexed_sales_orders.each do |sales_order|
      so_primary_details = {
          ...
          customer_order_number: sales_order.attributes['customer_po_number_string'],
  ...
  def get_sales_order_details(so_details, so_row, invoice_details = nil, purchase_order_details = nil)
    {
        ...
        customer_order_number: so_details[:customer_order_number],
        ...
        name: so_row['name'].present? ? so_row['name'] : '',
