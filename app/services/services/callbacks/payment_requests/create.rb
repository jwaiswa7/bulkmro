class Services::Callbacks::PaymentRequests::Create < Services::Callbacks::Shared::BaseCallback
  ...
  def call
    ...
    overseer = inquiry.inside_sales_owner
    begin
      if purchase_order.present?
        if purchase_order.payment_request.nil?
          payment_request = PaymentRequest.new
          payment_request.update_attributes(:purchase_order => purchase_order, :inquiry => inquiry, :po_request => po_request, :created_by => overseer)
