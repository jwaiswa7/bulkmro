            ...
            if params['is_kit'].to_i == 1
              ...
              invoice.rows.where(sku: sales_order_row.product.sku).first_or_initialize do |row|
                ...
                kit_meta_data = {
                    ...
                    :tax_amount =>  sales_order_row.tax_calculations * qty_kit,
                    :description =>  params['desc_kit'],
                    :order_item_id =>  nil,
                    :base_row_total =>  unit_price_kit * qty_kit,
                    :price_incl_tax => nil,
                    :additional_data => nil,
                    :base_tax_amount => sales_order_row.tax_calculations * qty_kit,
                    :discount_amount =>  nil,
                    :weee_tax_applied => nil,
                    :hidden_tax_amount => nil,
                    :row_total_incl_tax => (unit_price_kit * qty_kit) + (sales_order_row.tax_calculations * qty_kit),
