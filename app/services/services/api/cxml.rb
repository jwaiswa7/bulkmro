class Services::Api::Cxml < Services::Shared::BaseService
  ...
  def parser
    if params.body.present?
      ...
      landing_url = "https://new-sprint.herokuapp.com/customers/dashboard/route?email=#{contact_email}&amp;request_id=#{api_request_object.hashid}"
      ...
      if contact.present?
        node = CXML.builder
        node.cXML('payloadID' => parsed_body["payloadID"], 'timestamp' => timestamp.iso8601) do |doc|
