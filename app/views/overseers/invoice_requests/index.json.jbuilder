  ...
  json.array! [
                  [
                      if is_authorized(invoice_request, 'show')
                        row_action_button_without_fa(overseers_invoice_request_path(invoice_request), 'bmro-icon-table bmro-icon-used-view', 'View AP Request','bmro-icon-table bmro-icon-used-view','info')
                      end,
                      if is_authorized(invoice_request, 'edit')
                        row_action_button_without_fa(edit_overseers_invoice_request_path(invoice_request), 'bmro-icon-table bmro-icon-pencil', "Edit #{invoice_request.readable_status}",'bmro-icon-table bmro-icon-pencil', 'warning')
                      end,
