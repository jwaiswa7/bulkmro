json.data (@indexed_company_reports) do |company|
  json.array! [
                  ...
                  format_currency(company['sales_quotes_total']['value'].to_i, precision: 0),
                  if @date_range.present?
                  ...
                  format_currency(company['expected_orders_total']['value'].to_i, precision: 0),
                  # if @date_range.present?
                  ...
                  # end,
                  format_currency(company['sales_orders_total']['value'].to_i, precision: 0),
                  format_currency(company['sales_orders_margin']['value'].to_i, precision: 0),
                  ...
                  # end,
                  format_currency(company['sales_invoices_total']['value'].to_i, precision: 0),
                  ...
                  # end,
                  format_currency(company['cancelled_invoiced_total']['value'].to_i, precision: 0),
