json.data (@material_pickup_requests) do |material_pickup_request|
  json.array! [
                  [
                      if is_authorized(material_pickup_request, 'update_logistics_owner_for_pickup_requests') && (material_pickup_request.status != 'Material Delivered')
                      ...
                      if is_authorized(material_pickup_request, 'delivered') && is_authorized(material_pickup_request, 'can_request_invoice')
                      ...
                      if is_authorized(material_pickup_request, 'show')
                      ...
                      if is_authorized(material_pickup_request, 'edit')
                      ...
                      if is_authorized(material_pickup_request, 'confirm_delivery')
                      ...
                      elsif material_pickup_request.invoice_request.present? && is_authorized(material_pickup_request.invoice_request, 'show')
                  ...
                  (conditional_link(material_pickup_request.purchase_order.inquiry.company.try(:name), overseers_company_path(material_pickup_request.purchase_order.inquiry.company), is_authorized(material_pickup_request.purchase_order.inquiry, 'show')) if material_pickup_request.purchase_order.po_request.present? && material_pickup_request.purchase_order.po_request.sales_order.present?),
                  ...
                  (material_pickup_request.purchase_order.supplier.present? ? conditional_link(material_pickup_request.purchase_order.supplier.try(:name), overseers_company_path(material_pickup_request.purchase_order.supplier), is_authorized(material_pickup_request.purchase_order.inquiry, 'show')) : '-'),
