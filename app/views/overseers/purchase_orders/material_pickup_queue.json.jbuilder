json.data (@material_pickup_requests) do |material_pickup_request|
  json.array! [
                  ...
                  (material_pickup_request.purchase_order.get_supplier(material_pickup_request.purchase_order.rows.first.metadata['PopProductId'].to_i).present? ? conditional_link(material_pickup_request.purchase_order.get_supplier(material_pickup_request.purchase_order.rows.first.metadata['PopProductId'].to_i).try(:name), overseers_company_path(material_pickup_request.purchase_order.get_supplier(material_pickup_request.purchase_order.rows.first.metadata['PopProductId'])), policy(material_pickup_request.purchase_order.inquiry).show?) : '-' if material_pickup_request.purchase_order.rows.present?),
