json.data (@material_pickup_requests) do |material_pickup_request|
  json.array! [
                  ...
                  (format_succinct_date(material_pickup_request.purchase_order.po_request.sales_order.mis_date).to_date if material_pickup_request.purchase_order.po_request.present? && material_pickup_request.purchase_order.po_request.sales_order.present?),
                  (format_succinct_date(material_pickup_request.purchase_order.po_request.supplier_committed_date).to_date if material_pickup_request.purchase_order.po_request.present?),
                  ...
                  format_succinct_date(material_pickup_request.purchase_order.metadata['PoDate']),
