json.data (@material_pickup_requests) do |material_pickup_request|
  json.array! [
                  ...
                  (material_pickup_request.purchase_order.supplier.present? ? conditional_link(material_pickup_request.purchase_order.supplier.try(:name), overseers_company_path(material_pickup_request.purchase_order.supplier), policy(material_pickup_request.purchase_order.inquiry).show?) : '-'),
