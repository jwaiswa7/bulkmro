json.data (@purchase_orders) do |purchase_order|
  json.array! [
                  [
                      ...
                      if is_authorized(purchase_order, 'change_material_status') && policy(purchase_order).change_material_status? && !(purchase_order.material_status == 'Manually Closed') && policy(purchase_order).manually_close?
