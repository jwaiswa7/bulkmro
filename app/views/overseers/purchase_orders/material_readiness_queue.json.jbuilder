json.data (@purchase_orders) do |purchase_order|
  columns = [
                  ...
                  conditional_link((purchase_order.po_request.present? && purchase_order.po_request.sales_order.present?) ? purchase_order.po_request.sales_order.order_number : '-', overseers_inquiry_sales_order_path(purchase_order.po_request.sales_order.inquiry, purchase_order.po_request.sales_order), is_authorized(purchase_order.po_request.sales_order, 'show')),
