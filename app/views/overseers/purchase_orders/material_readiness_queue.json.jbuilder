json.data (@purchase_orders) do |purchase_order|
  columns = [
                  ...
                  if purchase_order.po_request.present? && purchase_order.po_request.sales_order.present?
                    is_authorized(purchase_order.po_request.sales_order, 'show') ? link_to(purchase_order.po_request.sales_order.order_number, overseers_inquiry_sales_order_path(purchase_order.po_request.sales_order.order_number, purchase_order.po_request.sales_order), target: '_blank') : purchase_order.po_request.sales_order.order_number
                  else
                    ''
                  end,
