json.data (@inward_dispatches) do |inward_dispatch|
  json.array! [
                  [
                      if is_authorized(inward_dispatch, 'update_logistics_owner_for_inward_dispatches') && (inward_dispatch.status != 'Material Delivered')
                      ...
                      if is_authorized(inward_dispatch, 'delivered') && is_authorized(inward_dispatch, 'can_request_invoice')
                      ...
                      if is_authorized(inward_dispatch, 'edit')
                      ...
                      if is_authorized(inward_dispatch, 'confirm_delivery')
                      ...
                      elsif inward_dispatch.invoice_request.present? && is_authorized(inward_dispatch.invoice_request, 'show')
