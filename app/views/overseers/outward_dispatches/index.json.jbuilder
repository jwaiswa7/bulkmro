json.data (@outward_dispatches) do |outward_dispatch|
  ...
  json.array! [
                  ...
                  format_boolean(outward_dispatch.dispatch_mail_sent_to_the_customer || (outward_dispatch.status == 'Material Ready for Dispatch') || (outward_dispatch.status == 'Material Delivered')),
                  format_boolean(outward_dispatch.material_delivered_mail_sent_to_customer || (outward_dispatch.status == 'Material Delivered')),
