  ...
  json.array! [
                  [
                      ...
                      if is_authorized('overseer', 'edit') && policy(overseer).edit_acl?
                        row_action_button_without_fa(edit_acl_overseers_overseer_path(overseer), 'bmro-icon-table bmro-icon-lock', 'Edit ACL', 'success')
                      end,
                      ...
                      if is_authorized('overseer', 'change_password') && policy(overseer).change_password?
                        row_action_button_without_fa(change_password_overseers_overseer_path(overseer), 'bmro-icon-table bmro-icon-key', 'Edit Password Overseer', 'danger')
                      end
                  ].join(' '),
