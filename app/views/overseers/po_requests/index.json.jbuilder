json.data (@po_requests) do |po_request|
  json.array! [
                  [
                      ...
                      if is_authorized(po_request, 'index')
                      ...
                      if is_authorized(po_request, 'new_purchase_order') && action_name == 'pending_and_rejected' && po_request.status != 'Supplier PO Request Rejected'
