json.data (@activities) do |activity|
  json.array! [
                  ...
                  if activity.activity_account.present?; link_to(activity.activity_account.to_s, overseers_account_path(activity.activity_account), target: "_blank") end,
                  if activity.activity_company.present?; link_to(activity.activity_company.to_s, overseers_company_path(activity.activity_company), target: "_blank") end,
