json.data (@activities) do |activity|
  json.array! [
                  [
                      ...
                      if !activity.contact.present? && activity.contact_creation_request.present? && !activity.contact_creation_request.contact_id.present? && policy(activity.contact_creation_request).show?;
