json.data (@sales_invoices) do |sales_invoice|
  json.array! [
                  ...
                  link_to(sales_invoice.invoice_number, overseers_inquiry_sales_invoices_path(sales_invoice.inquiry), target: "_blank"),
                  link_to(sales_invoice.inquiry.present? ? sales_invoice.inquiry.inquiry_number : "", edit_overseers_inquiry_path(sales_invoice.inquiry), target: '_blank'),
                  link_to(sales_invoice.inquiry.present? ? sales_invoice.sales_order.order_number : "", overseers_inquiry_sales_order_path(sales_invoice.inquiry, sales_invoice.sales_order), target: "_blank"),
