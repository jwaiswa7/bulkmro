json.data (@payment_requests) do |payment_request|
  json.array! [
                  ...
                  (payment_request.po_request.purchase_order.present? && !payment_request.po_request.purchase_order.is_legacy?) ? format_currency(payment_request.po_request.purchase_order.try(:calculated_total_with_tax)) : '-',
                  (payment_request.po_request.purchase_order.present? && !payment_request.po_request.purchase_order.is_legacy?) ? format_currency(payment_request.remaining_amount) : '-',
