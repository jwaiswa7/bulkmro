const validatePoRequestAddresses = () => {
    ...
    //
    //
    //         var selectedBillToCity = $(parsleyInstance.$element[0]).closest('div.po-request-form').find('[name*=bill_to_id] :selected').data('warehose-state');
    //         var selectedShipToCity = $(parsleyInstance.$element[0]).closest('div.po-request-form').find('[name*=ship_to_id] :selected').data('warehose-state');
    //
    //
    ...
    //             return true;
    //         } else if (supplier_po_type == "regular" && selectedBillToCity == selectedShipToCity) {
    //             return true;
    //         }
    //
    //         return false
