...
$('.bmro-Billing').click(function (){
    $('html, body').animate({
      scrollTop: $(".bmro-Billing-slide").offset().top - 70
    }, 1000)
})

$('.bmro-owner-details').click(function (){
    $('html, body').animate({
      scrollTop: $(".bmro-owner-details-slide").offset().top - 70 
    }, 1000)
}) 

$('.bmro-order-details-slide').click(function (){
    $('html, body').animate({
      scrollTop: $(".bmro-order-slide").offset().top - 80
    }, 1000)
})
...
$(".icon-title").hide(); // On very first line of scripts.js file


$(".icon-title").hover(function () {
    var elems = this;
    ...
    $(".icon-title").fadeIn('fast');
},

function () {
    $(".icon-title").fadeOut('fast');
});
export default edit