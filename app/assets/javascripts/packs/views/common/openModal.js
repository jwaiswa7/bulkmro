...
const openModal = () => {
    $('.datatable').on('click', '.revise-committed-delivery-date', function (e) {
        ...
        let so_id = $(this).data('sales-order-id');

        let json = {
            url: Routes.render_committed_date_revision_form_overseers_inquiry_sales_order_path(inquiry_id, so_id),
            modalId: '#revise-committed-delivery-date',
            className: '.revise-delivery-date',
