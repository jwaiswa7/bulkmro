    ...
    def po_request_params
      params.require(:po_request).permit(
        :contact_email,
          ...
          rows_attributes: [:id, :sales_order_row_id, :_destroy, :status, :quantity, :tax_code_id, :tax_rate_id, :brand_id, :product_id, :discount_percentage, :unit_price, :lead_time, :converted_unit_selling_price, :product_unit_selling_price, :conversion, :bp_catalog_name, :bp_catalog_sku, :default_currency, :selected_currency_up],
