class Overseers::OverseersController < Overseers::BaseController
  before_action :set_overseer, only: [:show, :edit, :update, :save_acl_resources, :get_resources, :get_menu_resources, :edit_acl, :update_acl]
  ...
  def show
    @annual_targets = @overseer.annual_targets
    authorize_acl @overseer
  end
