class Overseers::SalesOrders::EmailMessagesController < Overseers::SalesOrders::BaseController
  ...
  def material_dispatched_to_customer
    ...
    @email_message.assign_attributes(
        ...
        :body => SalesOrderMailer.material_dispatched_to_customer_details(@email_message).body.raw_source,
        :auto_attach => true
    )
  ...
  def material_dispatched_to_customer_notification
    ...
    if @email_message.save
      SalesOrderMailer.send_material_dispatched_to_customer(@email_message).deliver_now
