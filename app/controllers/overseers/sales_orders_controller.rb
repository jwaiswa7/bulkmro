class Overseers::SalesOrdersController < Overseers::BaseController
  ...
  def export_customer_order_status_report
    ...
    export_service = Services::Overseers::Exporters::CustomerOrderStatusReportsExporter.new(params['customer_order_status_report']['category'], current_overseer, @sales_orders, [])
    export_service.call
