...
class SalesOrdersIndex < BaseIndex
  ...
  define_type SalesOrder.all.with_includes do
    ...
    field :sales_order_rows do
      field :sku, value: ->(_record, sales_order_row) { sales_order_row.sales_quote_row.product.remote_uid }, analyzer: 'substring'
      field :brand, value: ->(_record, sales_order_row) { sales_order_row.sales_quote_row.product.brand.name if sales_order_row.sales_quote_row.product.brand.present? }, analyzer: 'substring'
      field :name, value: ->(_record, sales_order_row) { sales_order_row.sales_quote_row.product.name if sales_order_row.sales_quote_row.product.name.present? }, analyzer: 'substring'
      field :mpn, value: ->(_record, sales_order_row) { sales_order_row.sales_quote_row.product.mpn if sales_order_row.sales_quote_row.product.mpn.present? }, analyzer: 'substring'
    end
  end
end
