class SalesQuotesIndex < BaseIndex
  ...
  define_type SalesQuote.limit(1).with_includes do
    ...
    field :inside_sales_owner_id, value: -> (record) { record.inquiry.inside_sales_owner_id if record.inquiry.present? &&  record.inquiry.inside_sales_owner.present?}, type: 'integer'
