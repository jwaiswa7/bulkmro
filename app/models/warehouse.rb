...
class Warehouse < ApplicationRecord
  ...
  pg_search_scope :locate, against: [:name], associated_against: { address: %i[name country_code street1 street2 state_name city_name pincode] }, using: { tsearch: { prefix: true } }
