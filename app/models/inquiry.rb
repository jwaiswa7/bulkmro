class Inquiry < ApplicationRecord
  ...
  def set_defaults
    if self.company.present?
      ...
      default_commercial_terms_and_conditions = ["1. Cost does not include any additional certification if required as per Indian regulations.",
                                                 ...
                                                 "4. BulkMRO does not accept any financial penalties for late deliveries."].join("\r\n")

      self.commercial_terms_and_conditions ||= default_commercial_terms_and_conditions
    end
