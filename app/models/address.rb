class Address < ApplicationRecord
  ...
  # validates_presence_of :telephone, if: -> { :not_legacy? && self.telephone.blank?  } TODO: Uncomment Later
  # validates_presence_of :mobile, if: -> { :not_legacy? && self.mobile.blank? } TODO: Uncomment Later
