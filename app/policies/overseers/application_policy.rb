class Overseers::ApplicationPolicy
  ...
  def developer?
    ['bhargav.trivedi@bulkmro.com', 'saurabh.bhosale@bulkmro.com', 'sourabh.raje@bulkmro.com', 'lopesh.durugkar@bulkmro.com', 'ruta.kambli@bulkmro.com', 'rucha.parab@bulkmro.com', 'meenakshi.naik@bulkmro.com', 'pradeep.ketkale@bulkmro.com', 'sakshi.yadav@bulkmro.com', 'sufiyan.siddique@bulkmro.com'].include? overseer.email
  end
