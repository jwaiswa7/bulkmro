class Overseers::SalesOrderPolicy < Overseers::ApplicationPolicy
  ...
  def edit_mis_date?
    record.persisted? && ['vijay.manjrekar@bulkmro.com', 'gaurang.shah@bulkmro.com', 'devang.shah@bulkmro.com', 'nilesh.desai@bulkmro.com', 'bhargav.trivedi@bulkmro.com'].include?(overseer.email)
  end
