class Resources::Quotation < Resources::ApplicationResource
  ...
  def self.to_remote(record)
    ...
    sales_quote = record.sales_quotes.order(:sent_at).reverse().first
    ...
    sales_quote.rows.each do |row|
      ...
      item.ProjectCode = record.project_uid # Project Code
...
=end
    ...
    return {
        ...
        "ProjectCode": record.project_uid, #Project Code
