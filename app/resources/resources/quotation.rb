class Resources::Quotation < Resources::ApplicationResource
  ...
  def self.to_remote(record)
    ...
    company_shipping_contact = record.inquiry.shipping_company.company_contacts.joins(:contact).where('contacts.email = ?', record.inquiry.shipping_contact.email).first
    {
