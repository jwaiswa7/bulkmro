class Resources::Item < Resources::ApplicationResource
  ...
  def self.to_remote(record)
    params = {
        ...
        ItemsGroupCode: record.category.remote_uid.blank? ? 100 : record.category.remote_uid, #record.category.remote_uid, # Product Category
        PurchaseItem: "tYES", # TO BE CREATED IN MAGENTO
        SalesItem: "tYES", # TO BE CREATED IN MAGENTO
        Mainsupplier: nil, # Supplier ID
        Manufacturer: record.brand.remote_uid.blank? ? nil : record.brand.remote_uid, # Product Manufacturer
        Valid: "tYES", # Status
        ...
        U_Category: record.category.remote_uid.blank? ? 100 : record.category.remote_uid,#record.category.remote_uid, # ????
