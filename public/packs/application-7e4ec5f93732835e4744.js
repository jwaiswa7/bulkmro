...
var setup = function setup() {
    $('.datatable').each(function () {
        ...
        $(this).DataTable({
            ...
            dom: "" + "<'row'<'col-12'<'input-group'f>>> <'col-sm-12 col-md-6'l>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-12  align-items-center text-center'i><'col-12 align-items-center text-center'p>>",
            "pageLength": 20,
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-7e4ec5f93732835e4744.js.map