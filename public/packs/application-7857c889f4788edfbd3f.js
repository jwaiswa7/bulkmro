        ...
        $(this).DataTable({
            ...
            initComplete: function initComplete(settings, json) {
                this.find('th').each(function (i) {
                    ...
                    var td = this.find('thead tr:eq(1) td:eq(' + i + ')');
                    var input = '';

                    if (filter != 'false' && filter != false) {
                        if (filter == 'dropdown') {
                            input = '<select class="custom-select"><option value=""></option></select>';
                        } else {}
                    }
                });
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-7857c889f4788edfbd3f.js.map