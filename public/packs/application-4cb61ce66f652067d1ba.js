            ...
            initComplete: function initComplete(settings, json) {
                ...
                this.api().columns().every(function () {
                    ...
                    if (filter && filter != false) {
                        ...
                        if (filter == 'dropdown') {
                            input = $('<select class="select2-single form-control" data-placeholder="' + 'Select ' + $(column.header()).text() + '"><option disabled></option></select>');
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-4cb61ce66f652067d1ba.js.map