                ...
                this.api().columns().every(function () {
                    ...
                    if (filter && filter != false) {
                        if (filter == 'dropdown') {
                            ...
                            json.columnFilters[this.index() - 1].forEach(function (f) {
                                $(input).append('<option value="' + f.value + '">' + f.label + '</option>');
                            });
                        }
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-c331246fa32036bf9ef5.js.map