            ...
            initComplete: function initComplete(settings, json) {
                ...
                this.api().columns().every(function () {
                    ...
                    if (filter && filter != false) {
                        ...
                        if (filter == 'dropdown') {
                            input = $('<select class="select2-single form-control" data-placeholder="' + 'Select ' + $(column.header()).text() + '"></select>');
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-fee9a699613500bf01fd.js.map